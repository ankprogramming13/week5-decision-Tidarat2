...
int main () {
  ...
  cin >> choice1;
    switch(choice1) {
    case 'B' : score += 10; life -= 1; cout << "Let's take the money to pay at the place to the car." << endl; break;
    case 'A' : score += 50; cout << "Call a friend to pay the car when it comes to school." << endl; break;
 ...
 cin >> choice2;
    switch(choice2) {
    case 'B' : score += 10; life -= 1; cout << "Have to pay the car." << endl; break;
    case 'A' : score += 50; cout << "A friend paid for a car." << endl; break;
    default : cout << "buffalo" << endl;
      }
 ...
 cin >> choice3;
    switch(choice3) {
    case 'B' : score += 10; life -= 1; cout << "Must pay for a return trip home." << endl; break;
    case 'A' : score += 50; cout << "Borrow money from friends to pay back home." << endl; break;
    default : cout << "buffalo" << endl;
      }
